...
const Main = () => {
  return (
    <div id="whychooseus" className="justify-center align-center">
      <h1 className="text-center font-bold text-3xl font-quicksand  mt-8 lg:mb-0 xl:-mb-8 -mb-10">
        Why FarmHand?
      </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 md:pl-4 md:pr-4 ">
          ...
          <div className="flex flex-col items-center sm:items-start">
            {textBlocks1.map((block, index) => (
              <div
                key={index}
                className="font-quicksand max-w-4xl xl:pl-0 pl-1 mt-4 sm:mt-0 flex items-center gap-4"
              >
        ...
        <div className="flex flex-col-reverse sm:flex-row items-center gap-4 mt-12 mb-12 md:pr-4 md:pl-4">
          <div className="flex flex-col items-center w-full">
            {textBlocks2.map((block, index) => (
              <div
                key={index}
                className="font-quicksand mt-10 max-w-4xl xl:pl-0 pl-1 flex items-center gap-4"
              >
                <IoCheckmarkDone className="lg:h-6 lg:w-6 h-8 w-8 text-green-600" />
                <p className="lg:text-lg text-sm">{block.text}</p>
              </div>
